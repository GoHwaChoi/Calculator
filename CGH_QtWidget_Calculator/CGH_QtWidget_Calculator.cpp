...
//void CGH_QtWidget_Calculator::on_Button_backspaceExpr()     //수식 마지막 문자열 지우기(on_Button_backspaceExpr)
//{
...
void CGH_QtWidget_Calculator::on_Button_backspaceExpr()     //숫자 마지막 문자열 지우기(on_Button_backspaceNum)
{
